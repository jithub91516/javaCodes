    ...
    private boolean saveProducts(ArrayList<Product> products) {
        ...
        try {
            ...
            for (Product p : products) {
                ...
                writer.writeStartElement("Madein");
                writer.writeCharacters(p.getMadein());
                writer.writeEndElement();
               
                writer.writeStartElement("Fabric");
                writer.writeCharacters(p.getFabric());
                writer.writeEndElement();
            ...
            while (reader.hasNext()) {
                ...
                switch (eventType) {
                    case XMLStreamConstants.START_ELEMENT:
                        ...
                        if (elementName.equals("madein")) {
                            String madein = reader.getElementText();
                            p.setDescription(madein);
                        }
                        
                        if (elementName.equals("fabric")) {
                            String fabric = reader.getElementText();
                            p.setDescription(fabric);
                        }
